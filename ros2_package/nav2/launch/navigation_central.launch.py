...
def include_launch_description(context: LaunchContext):
    ...
    pkg_dir = get_package_share_directory('nav2')
    ...
    bringup_launch_cmd = IncludeLaunchDescription(
        ...
        PythonLaunchDescriptionSource(os.path.join(nav2_launch_file_dir, 'bringup.launch.py')),
        launch_arguments={
            'autostart': autostart,
...
def generate_launch_description():
    ...
    #default_rviz_config_file = os.path.join(pkg_dir, 'rviz', 'config_navigation_central.rviz')
    default_rviz_config_file = os.path.join(pkg_dir, 'rviz', 'config_central_test.rviz')
    # Launch Arguments
