...
def generate_launch_description():
    ...
    robot_state_publisher_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_file_dir, 'prius_mapping_state.launch.py')),
        launch_arguments={'use_sim_time': use_sim_time, 'namespace': namespace}.items()
    )
    spawn_prius_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_file_dir, 'spawn_prius_mapping.launch.py')),
    ...
    # remap prius/odom to /odom for compatibility with slam_toolbox
    # remap prius/base_link to /base_footprint for compatibility with slam_toolbox
    # remap prius/base_scan to /scan for compatibility with slam_toolbox

    remappings = [('/prius/odom', '/odom'), ('/prius/base_link', '/base_footprint'), ('/prius/base_scan', '/scan')]
