...
def include_launch_description(context: LaunchContext):
    ...
    robot_state_publisher_node = Node(
        ...
        #remappings = [
        #    ('/robot_description', str(context.launch_configurations['namespace']) + '/robot_description')
        #]
...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_dir, 'models/central_controller/model.urdf')
    # Launch Arguments
