...
def generate_launch_description():
    ...
    first_prius_launch_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_file_dir, 'prius_keyboard_start.launch.py')),
        launch_arguments={
            'name': 'prius_keyboard',  # Change the name for the second Prius model
            'namespace': 'prius_keyboard',  # Change the namespace for the second Prius model
