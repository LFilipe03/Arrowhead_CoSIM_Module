...
def generate_launch_description():
    ...
    central_launch_cmd = IncludeLaunchDescription(
    ...
    params_file = os.path.join(nav2_pkg_dir, 'config', 'nav2_params', 'small_road','nav2_params_central_actor.yaml')
    nav_launch_file_dir = os.path.join(nav2_pkg_dir, 'launch')
    navigation_central_cmd = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(nav_launch_file_dir, 'navigation_central.launch.py')),
                launch_arguments={
                'map': map_file,
    ...
    launch_description.add_action(central_launch_cmd)
    launch_description.add_action(navigation_central_cmd)
