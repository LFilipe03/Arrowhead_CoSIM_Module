...
def generate_launch_description():
    ...
    # Launch and spawn Edge

    edge_launch_arg = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_file_dir, 'edge_start.launch.py')),
        launch_arguments={
            'use_sim_time': use_sim_time,
            'namespace': 'edge',
            'name': 'edge',
    ...
    launch_description.add_action(edge_launch_arg)
