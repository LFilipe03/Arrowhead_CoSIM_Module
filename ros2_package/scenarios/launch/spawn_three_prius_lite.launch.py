...
def generate_launch_description():
    ...
    first_prius_launch_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            'name': 'prius_lite',  # Change the name for the second Prius model
            'namespace': 'prius_lite',  # Change the namespace for the second Prius model
            'x_pose': '260.0',  # Change the x position for the second Prius model
            ...
            'y_orientation': '3.14159',  # Change the yaw orientation for the second Prius model
        }.items(),
    )
    ...
    second_prius_launch_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'namespace': 'prius_lite',  # Change the namespace for the second Prius model
            'x_pose': '210.0',  # Change the x position for the second Prius model
            'y_pose': '7.1',   # Change the y position for the second Prius model
            'z_pose': '0.1',   # Change the z position for the second Prius model
            'r_orientation': '0.0',  # Change the roll orientation for the second Prius model
            'p_orientation': '0.0',  # Change the pitch orientation for the second Prius model
    ...
    third_prius_launch_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_file_dir, 'spawn_prius_lite.launch.py')),
        launch_arguments={
            'name': 'prius_lite3',  # Change the name for the second Prius model
            'namespace': 'prius_lite',  # Change the namespace for the second Prius model
            'x_pose': '235.0',  # Change the x position for the second Prius model
            'y_pose': '4.021',   # Change the y position for the second Prius model
            'z_pose': '0.1',   # Change the z position for the second Prius model
            'r_orientation': '0.0',  # Change the roll orientation for the second Prius model
            'p_orientation': '0.0',  # Change the pitch orientation for the second Prius model
            'y_orientation': '3.14159',  # Change the yaw orientation for the second Prius model
    ...
    launch_description.add_action(third_prius_launch_cmd)
