#include "artery/ros2/ArrowheadRobotPositionProvider.h"
...
Define_Module(ArrowheadRobotPositionProvider)
...
void ArrowheadRobotPositionProvider::initialize(int stage)
{
...
int ArrowheadRobotPositionProvider::numInitStages() const
{
    return InitStages::Total;
}

void ArrowheadRobotPositionProvider::receiveSignal(cComponent*, simsignal_t signal, cObject*, cObject*)
{
...
void ArrowheadRobotPositionProvider::updatePositionFix()
{
...
Position ArrowheadRobotPositionProvider::getCartesianPosition() const
{
    return mMobility->getSimulationPosition();
}

GeoPosition ArrowheadRobotPositionProvider::getGeodeticPosition() const
{
