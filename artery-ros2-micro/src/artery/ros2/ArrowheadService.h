...
#ifndef ARROWHEADSERVICE_H_
#define ARROWHEADSERVICE_H_
...
class ArrowheadService : public ItsG5Service
{
    public:
        ArrowheadService();
        ~ArrowheadService();
    ...
    private:
        ...
        Ros2Node rosNode;
        rclcpp::Publisher<arrowhead_msgs::msg::ServiceRegistration>::SharedPtr publisher;
};

} // namespace artery

#endif /* ARROWHEADSERVICE_H_ */
