#ifndef ARTERY_ARROWHEADROBOTINETMOBILITY_H_T7FXXEAE
#define ARTERY_ARROWHEADROBOTINETMOBILITY_H_T7FXXEAE
...
private:
    ...
    rclcpp::Subscription<>::SharedPtr arrowheadSub;
...
#endif /* ARTERY_ARROWHEADROBOTINETMOBILITY_H_T7FXXEAE */
